...
<#macro browseBar model screen>
	...
	<table align="" id="browse" >
		<tr>	
			...
			<#else>
				<td style="vertical-align:middle;">
					...
					<select id="diseaseMapping" name="diseaseMapping" style="width:175px;float:left;" onchange="document.forms.${screen.name}.__action.value = '__qtlfinderhd__mappingChange';document.forms.${screen.name}.submit();">
						<option value="All Human Sources" <#if model.diseaseMapping?? && model.diseaseMapping == "allHumanSources">selected="selected"</#if>>Human: All datasources</option>
			...
			<td>
			<div class="buttons">
				<button style="height:30px;width:110px;float:right;vertical-align:middle;margin-top:5px;margin-right:5px;" type="button" id="search" onclick="document.forms.${screen.name}.__action.value = '__qtlfinderhd__resetAll';document.forms.${screen.name}.submit();"><img src="generated-res/img/reset.png" alt=""/>Reset All</button>
			</div>
			</td>
		</tr>	
		<tr>
