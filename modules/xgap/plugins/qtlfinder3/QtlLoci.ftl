...
<#----------------QTL LOCI SEARCH-------------------->
	<table align="center" width="800">
		...
		<tr align="center" style="margin-right:-50px;">
			...
			<td style="padding-left:10px;" width="50">
				LOD threshold:<br /> <input title="LOD Score Threshold" id="lodThreshold2" placeholder="e.g. 2.4 or 20" name="lodThreshold" type="text" size="10" <#if model.qtlSearchInputState.lodThreshold??>value="${model.qtlSearchInputState.lodThreshold}"</#if>>
			</td>
